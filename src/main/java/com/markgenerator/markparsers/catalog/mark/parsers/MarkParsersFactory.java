...
import com.markgenerator.markparsers.catalog.mark.parsers.ru.MilkPerishableMarkParser;
import com.markgenerator.markparsers.catalog.mark.parsers.ru.MilkWithShelfLifeMarkParser;
import com.markgenerator.markparsers.catalog.mark.parsers.ru.MilkWithoutShelfLifeMarkParser;
...
public class MarkParsersFactory {
    ...
    private static Set<MarkParser> buildRUParsers() {
        ...
        parsers.add(new MilkPerishableMarkParser());
        parsers.add(new MilkWithoutShelfLifeMarkParser());
        parsers.add(new MilkWithShelfLifeMarkParser());
